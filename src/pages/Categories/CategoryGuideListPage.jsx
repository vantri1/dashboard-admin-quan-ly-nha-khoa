// src/pages/Categories/CategoryGuideListPage.jsx

import { DeleteOutlined, EditOutlined, ExclamationCircleFilled, PlusOutlined, SearchOutlined } from '@ant-design/icons';
import { Alert, Button, Card, Form, Input, message, Modal, Space, Table, Typography } from 'antd';
import React, { useEffect, useState } from 'react';

import CategoryForm from '../../components/categories/CategoryForm'; // Tái sử dụng form có sẵn
...
// Dữ liệu giả lập
const initialData = [
    { id: 1, name: 'Hướng dẫn cho Lễ tân', slug: 'huong-dan-le-tan', guideCount: 12 },
    { id: 2, name: 'Hướng dẫn cho Bác sĩ', slug: 'huong-dan-bac-si', guideCount: 35 },
    { id: 3, name: 'Cài đặt & Cấu hình', slug: 'cai-dat-cau-hinh', guideCount: 28 },
];

const CategoryGuideListPage = () => {
    ...
    const columns = [
        ...
        { title: 'Số hướng dẫn', dataIndex: 'guideCount', key: 'guideCount', sorter: (a, b) => a.guideCount - b.guideCount },
        {
            title: 'Hành động',
            key: 'action',
            render: (_, record) => (
    ...
    return (
        <div className="space-y-4">
            <Title level={3}>Danh mục Hướng dẫn</Title>
            ...
            <CategoryForm open={isModalVisible} onCancel={handleCancel} onFinish={handleFinish} initialValues={editingCategory} />
        </div>
    );
};

export default CategoryGuideListPage;