// src/pages/CategoryProductListPage.jsx
...
// Dữ liệu giả lập
const initialData = [
    { id: 1, name: 'React', slug: 'react', productCount: 25 },
    { id: 2, name: 'VueJS', slug: 'vuejs', productCount: 18 },
    { id: 3, name: 'PHP', slug: 'php', productCount: 42 },
    { id: 4, name: 'NextJS', slug: 'nextjs', productCount: 15 },
    { id: 5, name: 'NodeJS', slug: 'nodejs', productCount: 30 },
];
...
const CategoryProductListPage = () => {
    ...
    const columns = [
        ...
        { title: 'Số sản phẩm', dataIndex: 'productCount', key: 'productCount', sorter: (a, b) => a.productCount - b.productCount },
        {
            title: 'Hành động',
            key: 'action',
            render: (_, record) => (
